...
urlpatterns = [
    ...
    path('api/create-comment/', views.CreateCommentView.as_view(), name='create_comment'),
    path('api/comment/<pk>/', views.CommentView.as_view(), name='comment'),

    path('api/post/<pk>/comments/', views.PostCommentsViewSet.as_view(), name='post_comments'),
    path('api/comment/<pk>/replies/', views.CommentRepliesViewSet.as_view(), name='comment_replies'),
]
